...
Public Class VisualizarProveedores

    Dim I As Integer
    Private Sub VisualizarProveedores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = ""
        CARGAR_DATAGRIDVIEW()
        ARMAR_DATAGRIDVIEW()
        BOTONES()
    ...
    Public Sub ARMAR_DATAGRIDVIEW()
        DataGridView1.Columns(0).HeaderText = "ID PROVEEDORES"
        DataGridView1.Columns(1).HeaderText = "NOMBRE PROVEEDOR"
        ...
        DataGridView1.Columns(5).HeaderText = "WEB"
    ...
    Public Sub CARGAR_DATAGRIDVIEW()
        ...
        Try
            ...
            DA_U = New SqlDataAdapter("select * from PROVEEDORES ORDER BY NOMBREPROVEEDOR", ConeccionBD.CONECCION)
            DS_U.Clear()
            DA_U.Fill(DS_U, "PROVEEDORES")
            DataGridView1.DataSource = DS_U.Tables("PROVEEDORES")
    ...
    Public Sub BOTONES()
        ...
        Try
            ConeccionBD.Abrir_BaseDato()
            DA_P = New SqlDataAdapter("select * from PROVEEDORES ORDER BY NOMBREPROVEEDOR", ConeccionBD.CONECCION)
            DA_P.Fill(DS_P, "PROVEEDORES")
    ...
    Private Sub CARGAR()
        ...
        Try
            ...
            Dim DA_U As SqlDataAdapter
            Dim DS_U As New DataSet
            DA_U = New SqlDataAdapter("select * from PROVEEDORES WHERE NOMBREPROVEEDOR like '%" & TextBox1.Text & "%' ORDER BY NOMBREPROVEEDOR", ConeccionBD.CONECCION)
            DS_U.Clear()
            DA_U.Fill(DS_U, "PROVEEDORES")
            DataGridView1.DataSource = DS_U.Tables("PROVEEDORES")
        Catch oExcep As SqlException
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            Dim editarForm As New FrmEditarProveedores

            ' Get the selected row
            Dim selectedRow As DataGridViewRow = DataGridView1.SelectedRows(0)

            ' Populate the text boxes on FrmEditarCliente with data from the selected row
            editarForm.TxtIdProveedor.Text = selectedRow.Cells("IDPROVEEDOR").Value.ToString()
            editarForm.TxtNombreProveedor.Text = selectedRow.Cells("NOMBREPROVEEDOR").Value
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        R = MessageBox.Show("Se dispone a Eliminar este registro de Proveedores, ¿Desea continuar?",
        ...
        If R = DialogResult.Yes Then
            ...
            Dim ELIMINA_SQL As String = "DELETE FROM DBO.PROVEEDORES WHERE IDPROVEEDOR = '" & P01 & "'"
