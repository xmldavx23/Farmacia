...
Public Class FrmProductos
    ...
    Public Sub ARMAR_DATAGRIDVIEW()
        ...
        DataGridView1.Columns(5).HeaderText = "PRE. UNIT."
        DataGridView1.Columns(6).HeaderText = "UNID. INV."
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            Dim editarForm As New FrmEditarProductos

            ' Get the selected row
            Dim selectedRow As DataGridViewRow = DataGridView1.SelectedRows(0)

            ' Populate the text boxes on FrmEditarCliente with data from the selected row
            editarForm.TxtIdProducto.Text = selectedRow.Cells("ID_PRODUCTO").Value.ToString()
            editarForm.TxtDescripcion.Text = selectedRow.Cells("DES_PRODUCTO").Value
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        R = MessageBox.Show("Se dispone a Eliminar este registro de Producto, ¿Desea continuar?",
        ...
        If R = DialogResult.Yes Then
            ...
            Dim ELIMINA_SQL As String = "DELETE FROM DBO.PRODUCTOS WHERE ID_PRODUCTO = '" & P01 & "'"
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim columnNames() As String = {"ID de Producto", "Descripción", "Categoría", "Proveedor", "Und. Presentación", "Precio Unitario", "Stock", "Descatalogado"}

        Dim columnSpacing As Single = 165
        If ConeccionBD.CONECCION.State = ConnectionState.Open Then
            ConeccionBD.Cerrar_BaseDato()
        End If
        Try
            ConeccionBD.Abrir_BaseDato()
            Dim DS_U As New DataSet
            command = New SqlCommand("SELECT * FROM productos", ConeccionBD.CONECCION)
