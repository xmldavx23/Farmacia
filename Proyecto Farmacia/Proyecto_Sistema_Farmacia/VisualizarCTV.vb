...
Public Class VisualizarCTV

    Dim I As Integer
    Private Sub VisualizarCTV_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = ""
        CARGAR_DATAGRIDVIEW()
        ARMAR_DATAGRIDVIEW()
        BOTONES()
    ...
    Public Sub ARMAR_DATAGRIDVIEW()
        DataGridView1.Columns(0).HeaderText = "ID CATEGORIA TIPO VENTA"
        DataGridView1.Columns(1).HeaderText = "CATEGORIA TIPO VENTA"
    ...
    Public Sub CARGAR_DATAGRIDVIEW()
        ...
        Try
            ...
            DA_U = New SqlDataAdapter("select * from CAT_TIPO_VENTA ORDER BY DESCRIPCION", ConeccionBD.CONECCION)
            DS_U.Clear()
            DA_U.Fill(DS_U, "CAT_TIPO_VENTA")
            DataGridView1.DataSource = DS_U.Tables("CAT_TIPO_VENTA")
    ...
    Public Sub BOTONES()
        ...
        Try
            ConeccionBD.Abrir_BaseDato()
            DA_P = New SqlDataAdapter("select * from CAT_TIPO_VENTA ORDER BY DESCRIPCION", ConeccionBD.CONECCION)
            DA_P.Fill(DS_P, "CAT_TIPO_VENTA")
    ...
    Private Sub CARGAR()
        ...
        Try
            ...
            Dim DA_U As SqlDataAdapter
            Dim DS_U As New DataSet
            DA_U = New SqlDataAdapter("select * from CAT_TIPO_VENTA WHERE DESCRIPCION like '%" & TextBox1.Text & "%' ORDER BY DESCRIPCION", ConeccionBD.CONECCION)
            DS_U.Clear()
            DA_U.Fill(DS_U, "CAT_TIPO_VENTA")
            DataGridView1.DataSource = DS_U.Tables("CAT_TIPO_VENTA")
        Catch oExcep As SqlException
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            Dim editarForm As New EditarCTV

            ' Get the selected row
            Dim selectedRow As DataGridViewRow = DataGridView1.SelectedRows(0)

            ' Populate the text boxes on FrmEditarCliente with data from the selected row
            editarForm.TxtId.Text = selectedRow.Cells("ID_TIPO_VENTA").Value.ToString()
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        R = MessageBox.Show("Se dispone a Eliminar este registro de categoria tipo venta, ¿Desea continuar?",
        ...
        If R = DialogResult.Yes Then
            ...
            Dim ELIMINA_SQL As String = "DELETE FROM DBO.CAT_TIPO_VENTA WHERE ID_TIPO_VENTA = '" & P01 & "'"
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        If DataGridView1.SelectedRows.Count > 0 Then
            ' Create an instance of FrmEditarCliente
            Dim editarForm As New FormCatTipoVenta

            ' Get the selected row
            Dim selectedRow As DataGridViewRow = DataGridView1.SelectedRows(0)

            ' Populate the text boxes on FrmEditarCliente with data from the selected row
            editarForm.TxtId.Text = selectedRow.Cells("IDCATEGORIA").Value.ToString()
