...
Public Class VisualizarLaboratorios

    Dim I As Integer

    Private Sub VisualizarLaboratorios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = ""
        CARGAR_DATAGRIDVIEW()
        ARMAR_DATAGRIDVIEW()
        BOTONES()
    ...
    Public Sub ARMAR_DATAGRIDVIEW()
        DataGridView1.Columns(0).HeaderText = "ID LABORATORIO"
        DataGridView1.Columns(1).HeaderText = "NOMBRE LABORATORIO"
        DataGridView1.Columns(2).HeaderText = "DIRECCION"
        DataGridView1.Columns(3).HeaderText = "TELEFONO"
        DataGridView1.Columns(4).HeaderText = "FAX"
        DataGridView1.Columns(5).HeaderText = "CONTACTO"
    ...
    Public Sub CARGAR_DATAGRIDVIEW()
        ...
        Try
            ...
            DA_U = New SqlDataAdapter("select * from LABORATORIOS ORDER BY NOMBRE", ConeccionBD.CONECCION)
            DS_U.Clear()
            DA_U.Fill(DS_U, "LABORATORIOS")
            DataGridView1.DataSource = DS_U.Tables("LABORATORIOS")
    ...
    Public Sub BOTONES()
        ...
        Try
            ConeccionBD.Abrir_BaseDato()
            DA_P = New SqlDataAdapter("select * from LABORATORIOS ORDER BY NOMBRE", ConeccionBD.CONECCION)
            DA_P.Fill(DS_P, "LABORATORIOS")
    ...
    Private Sub CARGAR()
        ...
        Try
            ...
            Dim DA_U As SqlDataAdapter
            Dim DS_U As New DataSet
            DA_U = New SqlDataAdapter("select * from LABORATORIOS WHERE NOMBRE like '%" & TextBox1.Text & "%' ORDER BY NOMBRE", ConeccionBD.CONECCION)
            DS_U.Clear()
            DA_U.Fill(DS_U, "LABORATORIOS")
            DataGridView1.DataSource = DS_U.Tables("LABORATORIOS")
        Catch oExcep As SqlException
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        R = MessageBox.Show("Se dispone a Eliminar este registro de Laboratorios, ¿Desea continuar?",
        ...
        If R = DialogResult.Yes Then
            ...
            Dim ELIMINA_SQL As String = "DELETE FROM DBO.LABORATORIOS WHERE IDLABORATORIO = '" & P01 & "'"
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            Dim editarForm As New FrmEditarLaboratorio

            ' Get the selected row
            Dim selectedRow As DataGridViewRow = DataGridView1.SelectedRows(0)

            ' Populate the text boxes on FrmEditarCliente with data from the selected row
            editarForm.TxtIdLaboratorio.Text = selectedRow.Cells("IDLABORATORIO").Value.ToString()
            editarForm.TxtNombreLaboratorio.Text = selectedRow.Cells("NOMBRE").Value
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            ' Populate the text boxes on FrmEditarCliente with data from the selected row
            editarForm.TxtIdLaboratorio.Text = selectedRow.Cells("ID LABORATORIO").Value.ToString()
            editarForm.TxtNombreLaboratorio.Text = selectedRow.Cells("NOMBRE LABORATORIO").Value
